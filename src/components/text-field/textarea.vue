<template>
  <div class="text-field-multiline">
    <textarea ref="textareaHidden" rows="1" class="text-field-textarea-hide text-field-input" :value="value"></textarea>
    <textarea ref="textarea" class="text-field-input text-field-textarea" :value="value" @change="handleChange" @input="handleInput" @focus="handleFocus" @blur="handleBlur" :disabled="disabled"></textarea>
  </div>
</template>
